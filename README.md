...
Cała architektura sieci Mainframe'u została zablokowana i przybrała formę gigantycznego, **ciemnofioletowo-błękitnego labiryntu Klastrów Szyfrujących (Encryption Blocks)**. Jedyne bezpieczne ścieżki to czarne **Magistrale Danych (Data Buses)**, którymi musisz się poruszać. 
...
* **🔹 Poziom 1: Inicjalizacja (The Subnet Entrance)**
  * **Trudność:** Niska.
...
* **🔹 Poziom 2: Przełamanie (The Firewall Layer)**
...
* **🔹 Poziom 3: Przechwytywanie (The Data Vaults)**
  * **Trudność:** Średnia.
...
* **🔹 Poziom 4: Kwarantanna (The Infected Subnet)**
  * **Trudność:** Wysoka.
...
* **🔹 Poziom 5: Rdzeń Centralny (The Mainframe Core)**
